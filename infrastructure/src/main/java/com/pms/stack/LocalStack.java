...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id, final StackProps props) {
        ...
        FargateService analyticService = createFargateService("AnalyticService",
                "analytic-service",
                List.of(8083),
                null,
                null);
    ...
    private DatabaseInstance createDatabase(String id, String dbName) {
        return DatabaseInstance.Builder
                ...
                .databaseName(dbName)
                .removalPolicy(RemovalPolicy.DESTROY) // This will destroy the data whenever the stack is destroyed. Use in "DEV"
                .build();
    }
